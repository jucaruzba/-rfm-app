...
const TasksPage = () => {
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      ...
      // Mapeamos las propiedades estructurales del objeto Page de Spring
  ...
  const handleCreateTask = async (e) => {
    ...
    try {
      ...
      setPage(0); // Forzamos ir a la primera página para ver la tarea creada
      fetchTasks();
    } catch (err) {
          ...
          <div className="w-full max-w-lg bg-white rounded-[2rem] p-8 relative shadow-2xl border border-gray-100 max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-6">
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wide mt-0.5">
                Define target client, timeline constraints and staff operator
              </p>
            </div>
